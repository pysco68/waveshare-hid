...
the GD32 series of ARM Cortex Microcontrollers by ST Microelectronics.

The GD32 series have four general purpose timers (2-5), while some have
...
#include <libopencm3/gd32/timer.h>
