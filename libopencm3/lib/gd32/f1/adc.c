...
@brief <b>libopencm3 GD32F1xx Analog to Digital Converters</b>
...
This library supports the A/D Converter Control System in the GD32F1xx series
...
Note that this is not available in other GD32F families. To ensure code
