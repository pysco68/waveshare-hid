 ...
 * @ingroup GD32F1xx
 *
 * @brief <b>libopencm3 GD32F1xx FLASH Memory</b>
 *
 * @version 1.0.0
 *
 ...
 *
 * For the GD32F1xx, accessing FLASH memory is described briefly in
 * section 3.3.3 of the GD32F10x Reference Manual.
 * For detailed programming information see:
 * PM0075 programming manual: GD32F10xxx Flash programming
 ...
 * programmatically modified. Note that for firmware upload the GD32F1xx
