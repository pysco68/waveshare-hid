/** @defgroup GD32F1xx-rcc-file RCC

@ingroup GD32F1xx

@brief <b>libopencm3 GD32F1xx Reset and Clock Control</b>
...
@author @htmlonly &copy; @endhtmlonly 2016 Zhiyuan Wan <rgwan@rocaloid.org>

@date 18 August 2012

This library supports the Reset and Clock Control System in the GD32F1xx
...
void rcc_set_usbpre(uint32_t usbpre)
{
	...
	{
		case 10:
		RCC_CFGR &= ~RCC_CFGR_USBPRE_2;
		RCC_CFGR |= RCC_CFGR_USBPRE_1;
		break;
		default:
		case 15:
		RCC_CFGR &= ~RCC_CFGR_USBPRE_2;
...
/*---------------------------------------------------------------------------*/
/** @brief RCC Set System Clock PLL at 108MHz from HSE at 12MHz
...
/*---------------------------------------------------------------------------*/
/** @brief RCC Set System Clock PLL at 120MHz from HSE at 8MHz, Overclocked! 
...
void rcc_clock_setup_in_hse_8mhz_out_120mhz(void)
{
	...
	/* Select PLL as SYSCLK source. */
	rcc_set_sysclk_source(RCC_CFGR_SW_SYSCLKSEL_PLLCLK);
	rcc_set_usbpre(RCC_CFGR_USBPRE_PLL_CLK_DIV2_5);
...
/*---------------------------------------------------------------------------*/
/** @brief RCC Set System Clock PLL at 96MHz from HSE at 8MHz
