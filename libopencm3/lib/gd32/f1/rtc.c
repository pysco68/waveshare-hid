 ...
 * @ingroup GD32F1xx
 *
 * @brief <b>libopencm3 GD32F1xx RTC</b>
 *
 ...
 * returned in certain cases. Refer to the GD32F1xx Reference Manual.
 *
...
#include <libopencm3/gd32/rtc.h>
#include <libopencm3/gd32/pwr.h>
