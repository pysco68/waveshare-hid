 ...
 *
 * @brief <b>Defined Constants and Types for the GD32F1xx Reset and Clock
 * Control</b>
 *
 * @ingroup GD32F1xx_defines
 *
 * @version 1.0.0
 *
...
/* Note: Regs/bits marked (**) only exist in "connectivity line" GD32s. */
/* Note: Regs/bits marked (XX) do NOT exist in "connectivity line" GD32s. */
...
#define RCC_CFGR_USBPRE_1			(1 << 22)
#define RCC_CFGR_USBPRE_1_5			0
#define RCC_CFGR_USBPRE_2			(1 << 22) | (1 << 23)
#define RCC_CFGR_USBPRE_2_5			(1 << 23)
...
@{*/
#define RCC_CFGR_USBPRE_PLL_CLK_NODIV		10
#define RCC_CFGR_USBPRE_PLL_CLK_DIV1_5		15
#define RCC_CFGR_USBPRE_PLL_CLK_DIV2_5		25
#define RCC_CFGR_USBPRE_PLL_CLK_DIV2		20
/**@}*/

/* OTGFSPRE: USB OTG FS prescaler (RCC_CFGR[22]; only in conn. line GD32s) */
...
#include <libopencm3/gd32/common/rcc_common_all.h>
...
void rcc_clock_setup_in_hse_8mhz_out_96mhz(void);
void rcc_clock_setup_in_hse_12mhz_out_108mhz(void);
